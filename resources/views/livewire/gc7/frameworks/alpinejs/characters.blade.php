            ...
            <div class="flex flex-wrap justify-between gap-4">
                ...
                <div x-cloak x-show="isOpen"
                    ...
                    <div class="flex items-center gap-10">
                        ...
                        <div class="text-3xl text-base-300 font-semibold leading-none px-2 pb-2" x-text="currentCharacter.name"></div>
                    </div>
                    <div class = "text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque impedit quidem autem atque. Ullam voluptates, eos molestiae molestias ab dolorem ratione distinctio numquam, eligendi voluptatibus sapiente porro odio ipsum eaque.</div>
                </div>
