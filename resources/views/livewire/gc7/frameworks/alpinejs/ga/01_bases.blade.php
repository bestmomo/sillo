<div>
    ...
    <div x-data="{ showSpoiler: false }">
        ...
        <x-button class='btn-primary w-[150px]' x-on:click="showSpoiler = !showSpoiler"><span
        ...
        <button class='btn btn-primary ml-2' x-transition.duration.2000ms x-show="!showSpoiler"
            @click="showSpoiler = true">Afficher le spoiler</button>
        ...
        <template x-if="showSpoiler">
            <p><strong>V 2: Ce paragraphe spoile le film...</strong> Porro vitae hic est tenetur ipsa ab a unde. Commodi
        ...
        <button
            ...
            x-on:click="showSpoiler = true" x-transition.duration.2000ms x-show="!showSpoiler">Show Spoiler</button>
