<?php
include_once 'users-chat.php';
?>

<div>
    <p class="w-1/4 flex justify-between items-center">N.B.:<x-icon-student color="#f22" /> <x-icon-smiley /></p>
    <ul>
    ...
    <form class="mt-2" wire:submit="submitMessage">
        ...
        <button class="btn btn-outline btn-primary my-3" type="submit">
            Send <x-icon-send color="{{ $sendIconColor }}" />
        </button>
    </form>
