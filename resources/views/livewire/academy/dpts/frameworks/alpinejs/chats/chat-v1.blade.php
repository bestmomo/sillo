...
<div class="relative -mt-6"
    ...
    x-init="Livewire.on('messageAdded', () => scrollToBottom());
    ...
    <form class="mt-3" wire:submit.prevent="submitMessage">
        <x-input wire:model="message" input="v1" />
        <button class="btn btn-outline btn-primary mt-3" type="submit">
            Send
