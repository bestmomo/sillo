...
<div class='text-lg'>
    <x-header class="text-green-400 font-shadow" title="L'ACADEMIE" shadow separator progress-indicator />
        ...
        <p class='text-justify'>
            ...
            En effet, si vous <i>' push ' *</i> votre code au <a class='link' href="https://github.com/bestmomo/sillo" target='_blank'>projet officiel</a> <x-ext-link />, de vrais utilisateurs auront accès à ces données...
        </p><br>
        ...
        <ul class="ml-3 list-disc list-inside">
            ...
            <li><a href="https://livewire.laravel.com/docs/quickstart" title="Doc. officielle LiveWire" target="_blank">LiveWire</a><x-ext-link /></li>
            <li><a href="https://alpinejs.dev/start-here" title="Doc. officielle AlpineJS" target="_blank">AlpineJS</a><x-ext-link /></li>
        </ul>
        ...
        <p class="text-justify">- Dans tous les cas, référez-vous aux <a class='link' href = 'https://github.com/bestmomo/sillo' target='_blank'>consignes de contribution du projet <b>Sillo</b></a> <x-ext-link />.
        ...
        <table class='my-2 mx-0'>
            <tr class='m-0'>
                ...
                <td><a class='link' href = 'https://docs.github.com/fr/get-started/learning-about-github/github-glossary#push' target='_blank'><b>Push</b></a> <x-ext-link /></td>
            </tr>
            <tr class='my-0'>
                <td class='w-1/4 text-right'>**</td>
                <td class='w-1/7 mx-3 px-3'>:</td>
            ...
            <tr class='m-0'>
                <td class='w-1/4 text-right'>***</td>
                <td class='w-1/7 mx-3 px-3'>:</td>
                <td><a class='link' href = 'https://docs.github.com/fr/get-started/learning-about-github/github-glossary#clone' target='_blank'><b>Clone</b></a> <x-ext-link />
                </td>
            </tr>
            <tr class='m-0'>
                <td class='w-1/4 text-right'>****</td>
                <td class='w-1/7 mx-3 px-3'>:</td>
                <td><a class='link' href = 'https://docs.github.com/fr/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/about-pull-requests' target='_blank'><b>P.R.</b></a> <x-ext-link />
                </td>
            </tr>
        </table>
